            ...
            {tab === "profile" && (
              <div className="bg-[#1a1d23] rounded-2xl p-8 border border-[#2d333b] space-y-6">
                ...
                <div className="grid grid-cols-2 gap-5">
                  ...
                  <FormInput id="s-last" label="Last Name" defaultValue="Wilson" />
            ...
            {tab === "system" && (
              <div className="bg-[#1a1d23] rounded-2xl p-8 border border-[#2d333b] space-y-6">
                ...
                <div className="space-y-5">
                  ...
                  <FormSelect id="s-backup" label="Backup Frequency"><option>Daily</option><option>Weekly</option></FormSelect>
                  <div className="flex items-center justify-between p-4 bg-[#0c0f16] rounded-xl border border-[#2d333b]">
                    <div>
