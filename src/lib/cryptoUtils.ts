 ...
 */
export async function encryptPayload(data: unknown, password: string): Promise<string> {
  const encoder = new TextEncoder();
 ...
 */
export async function decryptPayload(base64Payload: string, password: string): Promise<unknown> {
